...
public class SoniaTaskExample {

    public static final void main(String[] args) {
        try {
            RuntimeManager manager = getRuntimeManager("sonita/PedidoDepartamentoCompras.bpmn");        
            ...
            PedidoDepartamentoCompras notificacion = new PedidoDepartamentoCompras("sonya", "Nueva notebook", false, "Necesito una nueva notebook");
    		...
    		TaskSummary task1 = taskService.getTasksAssignedAsPotentialOwner("sales-rep", "es-ES").get(0);
            ...
            results.put("notificacion", notificacion);
...
//            taskService.complete(task4.getId(), "sales-rep", null);
    		...
    		System.out.println("Process instance completed lalala");
